...
--   0x0xxxxxxx  S0  SDRAM (via memory_arbiter M0)
--   0x4xxxxxxx  S1  SPI Master
--   0x5xxxxxxx  S2  PWM 10-bit
--   0x6xxxxxxx  S3  PWM 4-bit
--   0x7xxxxxxx  S4  GPIO
--   0x8xxxxxxx  S5  DMA control registers
...
begin
    ...
    begin
        case sel_adr(31 downto 28) is
            when "0000" => slv_idx <= 0;  -- 0x0xxxxxxx  SDRAM
            ...
            when "1000" => slv_idx <= 5;  -- 0x8xxxxxxx  DMA
